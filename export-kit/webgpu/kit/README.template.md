...
This WebGPU page was exported from Noisedeck. It plays your program with the same Noisemaker engine the app uses. It requests WebGPU first and uses WebGL2 if the browser has no WebGPU support. It fetches nothing at runtime.
...
`http://localhost` or HTTPS. Without WebGPU, the page renders through WebGL2 and identifies this backend in the footer. This prevents a blank export.
